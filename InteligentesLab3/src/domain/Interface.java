...
public class Interface {
	...
	/***********************************************************************************************************
	 * Class name: Main Description: in this class all computations of the
	 * executions of the problem are performed, including the main method with an
	 * example of a performed action on the field
	 * 
	 * @author Adrian Ollero Jimenez, Enrique Garrido Pozo, Pablo Mora Herreros
	 *         Subject: Intelligent Systems Group: A2
	 **********************************************************************************************************/
	public static void main(String[] args) throws IOException {
		...
		while (true) {
			...
			if (list != null) {
				boolean printImage = askPrintImage();
				...
				br.newLine();
				br.write("Value: " + list.get(0).getValue());
				br.newLine();
	...
	/**************************************************************************************
	 * Class name: menu Description: This is a menu that we use to choose the
	...
	/*********************************************************************************
	 * Method: obtainValue Description: This is method to check that the number that
	 * we are going to introduce is not a negative number
	 * 
	 * @param cadena
	 *            -> The program we will ask to us about what the program wants
	...
	private static boolean askPrintImage() {
		boolean ask = true;
		System.out.println("Solution Found...");
		while (ask) {
			System.out.println("Print image of field in file? (Y/N)");
			switch (sc.next()) {
			case "Y":
			case "YES":
			case "yes":
